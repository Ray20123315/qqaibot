...
(function(){
  ...
  document.addEventListener('click',function(ev){var t=ev.target.closest&&ev.target.closest('[data-view="member-data"],#memberDataNav');if(t)setTimeout(bootstrap,80)});
  if(e('v-member-data')&&e('v-member-data').classList.contains('active'))setTimeout(bootstrap,0);
})();
</script>`;
