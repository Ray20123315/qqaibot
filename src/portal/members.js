...
(function(){
  ...
  function notify(message){if(typeof toast==='function')toast(message);else if(typeof window.rayToast==='function')window.rayToast(message)}
