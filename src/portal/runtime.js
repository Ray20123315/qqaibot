...
function getPublicLandingPage() {
  ...
  return "<!doctype html><html lang=\"zh-Hant-TW\"><head><meta charset=\"utf-8\"><meta name=\"viewport\" content=\"width=device-width,initial-scale=1\"><meta name=\"theme-color\" content=\"#020714\"><title>AI Control Center</title><style>" + css + "</style></head><body>\n<div class=\"shell\">\n<header class=\"top\"><a class=\"brand\" href=\"/\"><span class=\"brand-mark\" aria-hidden=\"true\"><i></i><i></i></span><span class=\"brand-copy\"><b>AI Control Center</b><small>AI · Automation · BYOR</small></span></a><nav class=\"nav\"><a class=\"active hide-tablet\" href=\"/\">首頁</a><a class=\"hide-tablet\" href=\"#features\">核心功能</a><a class=\"hide-tablet\" href=\"#roles\">使用角色</a><a href=\"/register\">首次啟用</a><a class=\"nav-cta\" href=\"/login\">登入控制中心&nbsp;→</a></nav></header>\n<main>\n<section class=\"hero\">\n  <div class=\"hero-copy\">\n    <h1>把 AI、插件與自己的資源<br>放在<span class=\"gradient\">同一個控制中心</span></h1>\n    <p>使用帳號密碼登入；第一次建立帳號時完成身份驗證。透過插件生態與 BYOR，把自己的 Cloudflare 與外部 API 接入，打造真正屬於你的 AI 自動化工作空間。</p>\n    <div class=\"hero-actions\"><a class=\"btn primary\" href=\"/login\">登入控制中心 <span>→</span></a><a class=\"btn ghost\" href=\"/register\">第一次使用？建立帳號</a></div>\n    <div class=\"trust-row\">\n      <div class=\"trust\"><span class=\"trust-icon\">◇</span><span><b>安全登入</b><small>帳密、2FA、權限隔離</small></span></div>\n      <div class=\"trust\"><span class=\"trust-icon\">✦</span><span><b>插件擴展</b><small>受控能力與執行邊界</small></span></div>\n      <div class=\"trust\"><span class=\"trust-icon\">⬡</span><span><b>自己的資源</b><small>BYOR · 資料與成本自己掌控</small></span></div>\n    </div>\n  </div>\n  <div class=\"console-preview\" aria-label=\"AI Control Center 功能預覽\">\n    <div class=\"preview-top\"><div class=\"preview-brand\"><span class=\"brand-mark\"><i></i><i></i></span>AI Control Center</div><div class=\"preview-status\"><i class=\"dot\"></i>功能預覽 · 系統就緒</div></div>\n    <div class=\"preview-shell\">\n      <div class=\"preview-nav\"><span class=\"active\">總覽</span><span>AI 助理</span><span>插件中心</span><span>資源管理</span><span>工作流程</span><span>任務紀錄</span><span>權限與安全</span></div>\n      <div class=\"preview-main\">\n        <div class=\"preview-kicker\">CONTROL CENTER</div><h3>讓 AI 為你協調每一個工具</h3><p>實際資料會依你的帳號、權限與已連接資源顯示。</p>\n        <div class=\"preview-grid\">\n          <div class=\"preview-card\"><small>帳號安全</small><b>密碼 + 2FA</b><em>● 已支援</em></div>\n          <div class=\"preview-card\"><small>插件執行</small><b>權限隔離</b><em>● 按需授權</em></div>\n          <div class=\"preview-card\"><small>資源接入</small><b>BYOR</b><em>● 由你掌控</em></div>\n        </div>\n        <div class=\"flow\"><div class=\"flow-head\"><b>AI 工作流程</b><span>● 可組合</span></div><div class=\"flow-nodes\"><div class=\"flow-node\"><b>觸發事件</b>排程 / Webhook</div><div class=\"flow-node\"><b>AI 處理</b>模型 / 推理</div><div class=\"flow-node\"><b>插件執行</b>受控能力</div><div class=\"flow-node\"><b>輸出結果</b>通知 / API</div></div></div>\n        <div class=\"resource-strip\"><span class=\"resource-chip ready\"><i></i><b>D1</b> 自備</span><span class=\"resource-chip ready\"><i></i><b>KV</b> 自備</span><span class=\"resource-chip\"><i></i><b>R2</b> 可選</span><span class=\"resource-chip\"><i></i><b>Vectorize</b> 可選</span><span class=\"resource-chip\"><i></i><b>Workers AI</b> 自備</span></div>\n      </div>\n    </div>\n  </div>\n</section>\n<section class=\"section\" id=\"features\">\n  <div class=\"section-headline\"><div><div class=\"section-kicker\">CORE CAPABILITIES</div><h2>不是通用模板，是你這套 AI 平台真正會用到的能力</h2></div><p>從登入、插件、安全到 BYOR，把目前已經做好的功能整理成同一套控制中心語言。</p></div>\n  <div class=\"feature-grid\">\n    <article class=\"feature\" style=\"--accent:#3ba7ff\"><div class=\"feature-icon\">ID</div><h3>帳號密碼登入</h3><p>首次啟用後使用自訂帳號與密碼；第二因素與復原流程保留。</p><div class=\"feature-foot\">ACCOUNT SECURITY →</div></article>\n    <article class=\"feature\" style=\"--accent:#8d63ff\"><div class=\"feature-icon\">✓</div><h3>首次啟用身份驗證</h3><p>第一次建立帳號才驗證身份，完成後把身份與權限安全綁定。</p><div class=\"feature-foot\">FIRST ACTIVATION →</div></article>\n    <article class=\"feature\" style=\"--accent:#b96bff\"><div class=\"feature-icon\">◇</div><h3>插件中心</h3><p>插件有自己的信任狀態、權限與執行邊界，不把整個核心權限交出去。</p><div class=\"feature-foot\">PLUGIN ECOSYSTEM →</div></article>\n    <article class=\"feature\" style=\"--accent:#23d8ff\"><div class=\"feature-icon\">DB</div><h3>BYOR / 自備資源</h3><p>D1、KV、R2、Vectorize、Workers AI 與外部 API 由使用者自己的帳號負責。</p><div class=\"feature-foot\">YOUR RESOURCES →</div></article>\n    <article class=\"feature\" style=\"--accent:#ffb868\"><div class=\"feature-icon\">CF</div><h3>Cloudflare 資源接入</h3><p>未來由接入精靈逐項授權、連通檢查、建立或選擇現有資源。</p><div class=\"feature-foot\">RESOURCE ONBOARDING →</div></article>\n    <article class=\"feature\" style=\"--accent:#39e0af\"><div class=\"feature-icon\">ACL</div><h3>角色與權限管理</h3><p>前端入口不會提權；實際能力始終由伺服器 session 與 permissions 判定。</p><div class=\"feature-foot\">SERVER AUTHORITY →</div></article>\n  </div>\n</section>\n<section class=\"section\" id=\"roles\">\n  <div class=\"section-headline\"><div><div class=\"section-kicker\">BUILT FOR DIFFERENT ROLES</div><h2>同一個平台，不同的人只看到自己需要的能力</h2></div><p>角色是權限模型，不是裝飾標籤；登入後依實際授權開放功能。</p></div>\n  <div class=\"role-grid\">\n    <article class=\"role\"><div class=\"role-top\"><span class=\"role-icon\">&lt;/&gt;</span><h3>開發者</h3></div><p>維護核心、插件、部署與安全設定，掌握系統層級能力。</p></article>\n    <article class=\"role\"><div class=\"role-top\"><span class=\"role-icon\">◇</span><h3>實例管理員</h3></div><p>管理自己的部署、資源、插件與 BYOR 接入，不共用你的付費資源。</p></article>\n    <article class=\"role\"><div class=\"role-top\"><span class=\"role-icon\">AI</span><h3>AI 使用者</h3></div><p>直接使用 AI 功能、個人設定與允許的共享 Gemini 額度。</p></article>\n    <article class=\"role\"><div class=\"role-top\"><span class=\"role-icon\">◎</span><h3>社群成員</h3></div><p>所在社群已啟用服務時，使用被授權的社群與互動功能。</p></article>\n  </div>\n</section>\n<section class=\"cta-band\"><div><h2>YOUR AI · YOUR PLUGINS · YOUR RESOURCES</h2><p>先建立帳號，再把需要的能力一個一個接進來。</p></div><div class=\"hero-actions\"><a class=\"btn ghost\" href=\"/register\">首次啟用</a><a class=\"btn primary\" href=\"/login\">登入控制中心 →</a></div></section>\n</main>\n<footer class=\"footer\"><span>AI Control Center · AI-native automation platform</span><span>Simple · Powerful · Yours</span></footer>\n</div></body></html>";
}
