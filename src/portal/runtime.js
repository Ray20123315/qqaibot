...
async function loadPlugins(){var r=await api('/plugins');if(!r.ok){toast(r.message||t('common.unavailable'));return false}PORTAL_PLUGINS=Array.isArray(r.plugins)?r.plugins:[];pluginCanManage=r.canManage===true;renderPluginCatalog();return true}
