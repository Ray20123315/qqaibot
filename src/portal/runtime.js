  ...
  <main class="main">
    ...
    <div class="content">
      ...
      <section id="v-plugins" class="view">
        <div class="section-head"><div><h2 data-i18n="plugins.title">插件中心</h2><p data-i18n="plugins.subtitle">非必要能力以插件呈現；現有功能以相容橋接保留。</p></div></div>
        <div id="pluginGrid" class="plugin-grid"></div>
      </section>
      <section id="v-account" class="view">
        <div class="section-head"><div><h2 data-i18n="account.title">帳號與設定</h2><p data-i18n="account.subtitle">帳號安全、語言、外觀與目前身份。</p></div></div>
        <div class="core-grid account-grid">
          <div class="card"><h3 data-i18n="account.identity">目前身份</h3><div id="accountIdentitySummary" class="identity-summary">—</div></div>
          <div class="card"><h3 data-i18n="account.preferences">介面偏好</h3><div class="field"><label data-i18n="top.language">語言</label><select id="accountLocaleSelect"></select></div><button id="accountThemeToggle" class="btn ghost" type="button">深色</button></div>
        </div>
