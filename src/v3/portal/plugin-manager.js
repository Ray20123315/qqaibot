...
async function handleV3PluginManagerAuthed(request, env, url, body, session, overrides = {}) {
  ...
  if (channelMatch) {
    ...
    if (!runtimeState.runtimeEnabled) return jsonResponse({ ok: false, code: "V3_RUNTIME_DISABLED", message: "V3 Runtime 目前关闭，不能修改版本通道偏好。" }, 409);
