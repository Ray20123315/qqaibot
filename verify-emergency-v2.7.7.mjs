...
check(config.includes('const VERSION = "2.7.9";'), "runtime version must be 2.7.9");
check(pkg.version === "2.7.9", "package version must be 2.7.9");
...
console.log("Emergency v2.7.9 regression checks passed.");
