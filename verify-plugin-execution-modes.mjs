...
assert.ok(listBundledPlugins().length >= 7, "non-core feature families must be registered as bundled plugins");
...
assert.equal(catalog.some(item => item.id === "qqai.werewolf"), false, "werewolf must not remain in bundled plugins");
