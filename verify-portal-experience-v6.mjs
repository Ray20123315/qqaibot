...
assert.match(source,/RAY_MINIMAL_V9_START/,"minimal visual layer missing");
assert.doesNotMatch(source,/enhanceSelects\(document\);mountParticlesAll\(\);/,"minimal UI must not mount decorative particles automatically");
