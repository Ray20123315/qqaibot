...
assert(result.body.includes('class="public-home-v4"'), 'GET /: optimized public v4 homepage missing');
assert(result.body.includes('class="public-v4-hero"'), 'GET /: new public hero missing');
...
assert(result.body.includes('qqai.community'), 'GET /: plugin family preview missing');
